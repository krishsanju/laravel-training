...
<body>
    ...
    <div align = "left">
            ...
            Upload your photo<small> (.jpg, .jpeg, .png) </small> : <input type="file" name="photo"  required > <br><br>
            ...
            <input type="file" name="marks[]" accept=".pdf, .doc, .docx" multiple><br><br>
            ...
            <span style="color:red"><?= $errors['photo'] ?? '' ?></span><br>
            <span style="color:red"><?= $errors['memos'] ?? '' ?></span><br>
